...
data_ang <- read.csv("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Data/classifications_PU_zoon_final17.csv",header=T,sep=",")
data_td <- read.csv("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Data/classifications_PU_zoon_final.csv")
...
```
```{r prec2AS}
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/precision_AS.pdf",height=10,width=10)
colsums=colSums(conf_tab)
my_conf_tab=conf_tab
for(i in 1:5) my_conf_tab[,i]=my_conf_tab[,i]/colsums[i]
colSums(my_conf_tab)
...
```{r recall2}
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/recall_AS.pdf",height=10,width=10)
prop_cat=data.frame(conf_tab/rowSums(conf_tab)*100)  #generates recall because rows
prop_cat$id=paste(prop_cat$Lab,prop_cat$Zooniverse)
colnames(prop_cat)[3]<-"rec"
data.frame(conf_tab)->stall
...
```{r prec2AS}
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/precision_TD.pdf",height=10,width=10)
colsums=colSums(conf_tab)
my_conf_tab=conf_tab
for(i in 1:5) my_conf_tab[,i]=my_conf_tab[,i]/colsums[i]
colSums(my_conf_tab)
...
```{r recall2}
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/recall_TD.pdf",height=10,width=10)
prop_cat=data.frame(conf_tab/rowSums(conf_tab)*100)  #generates recall because rows
prop_cat$id=paste(prop_cat$Lab,prop_cat$Zooniverse)
colnames(prop_cat)[3]<-"rec"
data.frame(conf_tab)->stall
...
```{r corlab-zoo}
#Ling ratio
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/ling_rat_z_vs_l_final.pdf",height=5,width=5)
...
dev.off()
  #CR
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/can_rat_z_vs_l_final.pdf",height=5,width=5)
...
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/combined_final.pdf",height=5,width=5)
...
```{r corlab-zoo}
#Ling ratio
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/td_ling_rat_z_vs_l_final.pdf",height=5,width=5)
...
```{r corlab-zoo}
#Ling ratio
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/AS_ling_rat_z_vs_l_final.pdf",height=5,width=5)
...
dev.off()
  #CR
pdf("/Users/chiarasemenzin/Documents/GitHub/zoo-babble-validation/Results/AS_can_rat_z_vs_l_final.pdf",height=5,width=5)
...
```
```{r}
lin_mod=lm(z_lr~l_lr+Diagnosis,data=ratios)
summary(lin_mod)
```
