...
mytab_mj <- mytab>=3  #set as True the answer types that have 3 or more votes
...
maj_jud=cbind(row.names(mytab),mymj,nvotes)
colnames(maj_jud)<-c("chunkID","Answer","nvotes")
maj_jud2=as.data.frame(maj_jud)
maj_jud2$ChildID = gsub(" .*","",maj_jud2$chunkID)
  
#add participant information
merge(demo_data,maj_jud2,by="ChildID")->maj_jud

write.csv(maj_jud,"../data_analyses/output/chunks_maj_judgments.csv")

#add segment-level info from the lab
#TODO !!!

# read datasets
data_ang <- read.csv("segment_AS.csv",header=T,sep =",")
data_td <- read.csv("segment_LRC.csv")
