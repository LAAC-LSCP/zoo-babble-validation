...
result_final=pd.read_csv("/Users/chiarasemenzin/Desktop/LSCP/SLT/result_final_lisa.csv")  #file with segment info and lab classifications
result_zoon="/Users/chiarasemenzin/Desktop/Final_JSLHR/zooniverse_classifications/merged_classifs_1751.csv"#classifs from zooniverse merged with md

zoon=pd.read_csv(result_zoon)
stats_log="stats_log_19oct.txt" #give a name to the log

with open("/Users/chiarasemenzin/Desktop/Final_JSLHR/metadata/dict_4.json", "r") as read_file: # Put here path to json file
...
if __name__ == "__main__":
    ...
    total=pd.merge(result_final,zooniverse,on="segmentId_DB")
